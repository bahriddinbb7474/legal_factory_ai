...
Текущее состояние и результаты последних проверок уточняются в [CURRENT_STATE.md](CURRENT_STATE.md). Нормативные правила prompt/RAG/verdict workflow остаются в профильных policy-документах и имеют приоритет над краткими формулировками здесь.
...
- [CURRENT_STATE.md](CURRENT_STATE.md) — актуальное состояние, проверки и ближайший этап.
- [PROJECT_OVERVIEW.md](PROJECT_OVERVIEW.md) — краткий обзор проекта.
- [FINAL_TARGET.md](FINAL_TARGET.md) — исходная целевая картина.
- [ROADMAP_TO_FINAL.md](ROADMAP_TO_FINAL.md) — подробный существующий roadmap и история этапов.
- [MVP_SCOPE.md](MVP_SCOPE.md) — исходные границы MVP и сценарии.
...
После одобрения владельцем `ROADMAP_TO_FINAL.md` и `MVP_SCOPE.md` могут быть отдельно архивированы или удалены. В рамках текущей задачи они сохраняются без изменений.
